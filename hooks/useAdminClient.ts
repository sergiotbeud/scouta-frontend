...
/**
 * Hook para obtener la instancia del Admin Client desde el DI Container.
 * Sincroniza automáticamente el token cuando cambia en el store.
 * 
 * @returns Instancia de IAdminClient configurada y lista para usar
 */
export function useAdminClient(): IAdminClient {
